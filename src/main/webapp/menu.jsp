<%-- 
    Document   : menu
    Created on : Feb 14, 2025, 3:36:00 PM
                            ...
                            <nav id="navbar">
                                <div class="main-menu stellarnav">
                                    <ul class="menu-list">
                                        ...
                                        <li class="menu-item"><a href="searchServlet" class="nav-link">Product</a></li>
                                        ...
                                        <li class="menu-item"><a href="#download-app" class="nav-link">Contact</a></li>
                                    </ul>
