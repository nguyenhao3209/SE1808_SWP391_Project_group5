<%-- 
    Document   : Khanh
    Created on : Oct 4, 2024, 10:57:03 AM
    Author     : Khanh
--%>
        ...
        <div class="page-wraper">
            ...
            <div class="account-form">
                <div style="width: 600px;background: #666">
                    <div class="account-head" style="background-image:url(img/bg);
                         background-color: inherit;background-repeat: no-repeat;background-size: cover;
                         animation: zoom 10s infinite ease-in-out;overflow: hidden;">
                        ...
                        <form class="contact-bx" action="resetPassword" method="post">
                            <div class="row placeani">
                                ...
                                <div class="col-lg-12 m-b30">
                                    <button name="submit" type="submit" class="btn button-md">Reset Password</button>
                                </div>
                            </div>
                        </form>
                    </div>
