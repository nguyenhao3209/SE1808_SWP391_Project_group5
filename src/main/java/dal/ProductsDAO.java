...
public class ProductsDAO extends DBContext {
    ...
    public ArrayList<Products> searchProductsWithFilters2(String keyword, String[] categories, String[] brands, String priceRange, int pageNumber, int pageSize) {
        ...
        sql.append(" GROUP BY p.ProductID, p.ProductName, p.Price, p.StockQuantity, p.Brand, p.Category, p.Description, p.ImageURL, p.CreatedAt, p.UpdatedAt, p.DiscountProduct");
        ...
        try {
            ...
            while (rs.next()) {
                ...
                p.setDiscountProduct(rs.getBigDecimal("DiscountProduct"));
